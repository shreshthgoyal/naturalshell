...
const model = genAI.getGenerativeModel({ model: "gemini-pro" });
    ...
    const result = await oraPromise(model.generateContent(prompt), {successText : chalk.bold.greenBright(''), text : chalk.bold.cyanBright('🔍 Finding answers!'), failText: chalk.bold.red(`Invalid Request. Try again later!`)});
